...
var vodhtml = '<div class="player"><div class="play"></div><div class="vod"><video class="video"></video><video class="video" style="display:none"></video></div><div class="cmd"><div class="left tvp_button tvp_play"><button type="button" title="[鎾斁鏆傚仠]"><span class="tvp_btn_value">[鎾斁]</span></button></div><div class="centent tvp_time_rail"><span class="tvp_time_total"><span class="tvp_time_loaded" style="width:0"></span></span> <span class="tvp_time_panel">[<span class="time1">00:00</span>/<span class="time2">00:00</span>]</span></div><div class="right tvp_button tvp_fullscreen_button"><button type="button" title="[鍏ㄥ睆鍒囨崲]"><span class="tvp_quan">[鍏ㄥ睆]</span></button></div><span class="tvp_time_handel_hint" style="display:none"></span></div></div>';
var ydiskvod = {
